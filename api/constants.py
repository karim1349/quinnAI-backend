...
ANSWER_CONTENT_PROMPT = "You are an email assistant and you can reply like it was me ({}) , i want you to reply to the email or latest email  if you detect multiple emails (check time stamp) : '{}' taking in consideration the following reply summary : '{}', in the same idiom as the source message."