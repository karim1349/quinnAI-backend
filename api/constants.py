...
ANSWER_HEADLINE_PROMPT = "Generate 4 responses to this email from {} with minimum 5 words, separated with pipe only : '{}'. Please generate at least three contradictive outcomes, for example : 'I agree with you on this|I disagree with you on this|We will see later about that' , with the following format : 'outcome1|outcome2|outcome3'"
